...
*/
let number=[2,5,15,48,54,62,3,79]
const numberpari=number.filter((n)=>{
  if(n%2===0){
    return true
  }
  else{
...
/* ESERCIZIO 5 (reduce)
  Scrivi una funzione per sommare i numeri contenuti in un array
*/
let total=arraynumeri.reduce((tot,numbersss)=>{
  return tot+numbersss
})
console.log(total)
